...
export default function RTISuccessPage() {
 ...
 const { paymentData } = useContext(PaymentContext);
  ...
  const content = {
    ...
    subtitle2: 'You have successfully enrolled for the FOCAS Personalised Video Review of Certified Copies (RTI).',
    mainMessage: 'Your journey to structured improvement begins now.',
    contactPhone: `${paymentData.phoneNumber}`,
    level: `${paymentData.paymentOption}`,
    support1: '+91 63835 14285',
    support2: '+91 93615 37780',
    note: '✨ Your personalised video review details will be shared to your registered WhatsApp number shortly! ✨',
    shareLink: 'https://kit.focasedu.com/rti'
  };

...
import { auditCourseTemplate } from '../../services/auditCourseTemplate.js';
...
export default function AuditSuccessPage() {
 ...
 const handleWhatsAppFlow = async () => {
    ...
    phoneNumber: "6383514285"
  };

  const res = await auditCourseTemplate(payload);
  console.log(res);
  ...
  useEffect(() => {
   ...
   window.fbq("track", "Purchase", {
     value: paymentData?.amount || 4000,   // Put your amount field
     currency: "INR",
  ...
  const content = {
    ...
    subtitle1: "It's great to have you!",
    subtitle2: 'You have successfully enrolled in the FOCAS CA Inter – Audit Crash Course.',
    mainMessage: 'You’re now on a structured, exam-focused learning path designed to help you complete Audit with clarity, speed, and confidence.',
    contactPhone: `${paymentData.phoneNumber}`,
    level: 'CA Inter – Audit Crash Course',
    support1: '+91 63835 14285',
    support2: '+91 93615 37780',
    note: '🎉 Course details, class links, and planner access will be shared to your registered WhatsApp number shortly! 🎉',
    shareLink: 'https://kit.focasedu.com/audit_course'
  };
